  ...
  switch (opcode) {
    case spv::Op::OpConvertFToU: {
      ...
      if (!input_type || (!_.IsFloatScalarType(input_type) &&
                          ...
                          !_.IsFloatCooperativeMatrixHWType(input_type) &&
                          !_.IsFloatCooperativeVectorNVType(input_type) &&
                          !_.IsFloatCooperativeVectorHWType(input_type)))
        return _.diag(SPV_ERROR_INVALID_DATA, inst)
      ...
      if (_.IsCooperativeVectorNVType(result_type) ||
          ...
          _.IsCooperativeVectorHWType(input_type)) {
        spv_result_t ret =
        ...
        if (ret != SPV_SUCCESS) return ret;
                 ...
                 _.IsCooperativeMatrixHWType(input_type)) {
        spv_result_t ret =
    ...
    case spv::Op::OpConvertUToF: {
      ...
      if (!input_type ||
          (!_.IsIntScalarType(input_type) && !_.IsIntVectorType(input_type) &&
           ...
           !_.IsIntCooperativeMatrixHWType(input_type) &&
           !_.IsIntCooperativeVectorNVType(input_type) &&
           !_.IsIntCooperativeVectorHWType(input_type)))
        return _.diag(SPV_ERROR_INVALID_DATA, inst)
