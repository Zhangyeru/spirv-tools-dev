...
#define LAST_VARIABLE(ENUM)                         \
  ...
  SPV_OPERAND_TYPE_COOPERATIVE_MATRIX_USE_HW,
  SPV_OPERAND_TYPE_OPTIONAL_COOPERATIVE_MATRIX_USE_HW,
  ...
  SPV_OPERAND_TYPE_COOPERATIVE_MATRIX_REDUCE_SHIFT_HW,
  SPV_OPERAND_TYPE_COOPERATIVE_MATRIX_REDUCE_OP_HW,
  // Enum type from SPV_NV_cooperative_matrix2
  ...
  SPV_OPERAND_TYPE_COOPERATIVE_VECTOR_MATRIX_LAYOUT_HW,
